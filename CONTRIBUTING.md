...
You can file new issues by filling out our [new issue form](https://github.com/holidaylab/ngx-config/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/holidaylab/ngx-config/pulls) for an open or closed PR that relates to your submission.
...
Samples: (even more [samples](https://github.com/holidaylab/ngx-config/commits/master))
```
...
* **fs-loader**
* **merge-loader**
* **config-loader** (*which is actually packaged under `@ngx-universal` scope, but source code is located at the `ngx-config` repository*)
...
[coc]: https://github.com/holidaylab/ngx-config/blob/master/CODE_OF_CONDUCT.md
[github]: https://github.com/holidaylab/ngx-config
